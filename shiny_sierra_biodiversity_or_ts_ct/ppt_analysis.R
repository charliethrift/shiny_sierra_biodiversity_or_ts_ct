...
animals_raw <- read.csv(here("shiny_sierra_biodiversity_or_ts_ct", "data", "gbif_inat_animals_snarl.csv" ))
...
animal_density <- density(animals_snarl_ppp, sigma = 400)
...
setwd("C:\\Users\\olros\\OneDrive\\Desktop\\shiny_sierra_biodiversity_or_ts_ct\\shiny_sierra_biodiversity_or_ts_ct")
